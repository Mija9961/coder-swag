...
//        Category(title: "HATS", imageName: "hats.png"),
    ...
    private let hooddies = [
        Product(title: "Devslopes Logo Hoodie gray", price: "$32", imageName: "hoodie01.png"),
        Product(title: "Devslopes Logo Hoodie gray", price: "$32", imageName: "hoodie02.png"),
        Product(title: "Devslopes Logo Hoodie gray", price: "$32", imageName: "hoodie03.png"),
        Product(title: "Devslopes Logo Hoodie gray", price: "$32", imageName: "hoodie04.png")
    ]
    private let shirts = [
